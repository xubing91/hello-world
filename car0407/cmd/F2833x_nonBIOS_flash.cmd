...
PAGE 0:    /* Program Memory */
	...
	RAM_L0_6h	: origin = 0x008000, length = 0x006C00	   /* on-chip RAM */
...
/*    FLASHE      : origin = 0x318000, length = 0x008000*/     /* on-chip FLASH */
    FLASHD      : origin = 0x300000, length = 0x038000     /* on-chip FLASH */
/*    FLASHC      : origin = 0x332000, length = 0x006000*/     /* on-chip FLASH */
...
PAGE 1 :   /* Data Memory */
    ...
    RAML6h		: origin = 0x00EC00, length = 0x000400     /* on-chip RAM block L6*/
...
/*** User Defined Sections ***/
   ...
   /*DMARAML5         : > RAML567,    	PAGE = 1 */
   /*DMARAML6         : > RAML567,    	PAGE = 1 */
   /*DMARAML7         : > RAML567,     	PAGE = 1 */

   /* User Added */
   SD_BUFFER		: > RAML6h,			PAGE = 1
...
/*** Initialized Sections ***/                                          
  	.cinit			:	LOAD = FLASHD,		PAGE = 0        /* can be ROM */ 
                		RUN = RAM_L0_6h, 	PAGE = 0   		/* must be CSM secured RAM */
                		LOAD_START(_cinit_loadstart),
                		RUN_START(_cinit_runstart),
                		SIZE(_cinit_size)

	.const			:   LOAD = FLASHD,  	PAGE = 0        /* can be ROM */ 
                		RUN = RAM_L0_6h,		PAGE = 0    /* must be CSM secured RAM */
                		LOAD_START(_const_loadstart),
                		RUN_START(_const_runstart),
                		SIZE(_const_size)

	.econst			:   LOAD = FLASHD,  	PAGE = 0        /* can be ROM */ 
                		RUN = RAM_L0_6h, 	PAGE = 0        /* must be CSM secured RAM */
                		LOAD_START(_econst_loadstart),
               			RUN_START(_econst_runstart),
                		SIZE(_econst_size)

	.pinit			:   LOAD = FLASHD,  	PAGE = 0        /* can be ROM */ 
                		RUN = RAM_L0_6h, 	PAGE = 0        /* must be CSM secured RAM */
	...
	.text			:   LOAD = FLASHD, 		PAGE = 0        /* can be ROM */ 
                		RUN = RAM_L0_6h, 	PAGE = 0        /* must be CSM secured RAM */
